...
def login():
    ...
    if user is None:
        ...
        print('There was not a user with that email.', 'danger')
    elif user.password != password:
        print('The password was incorrect.')
        print('The password was incorrect.', 'danger')
    else:
...
def register():
    ...
    if check_user is not None:
        ...
        print('A user with this email already exists.', 'danger')
        

    elif password != confirm_password:
        print('The passwords do not match')
        print('The passwords do not match', 'danger')
